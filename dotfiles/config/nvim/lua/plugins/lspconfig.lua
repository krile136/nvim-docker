...
vim.keymap.set('n', 'gr', '<cmd>lua vim.lsp.buf.references()<CR>') --  参照しているファイル一覧を表示
vim.keymap.set('n', 'gj', '<cmd>lua vim.lsp.buf.definition()<CR>') -- 定義元にジャンプ
vim.keymap.set('n', 'gD', '<cmd>lua vim.lsp.buf.declaration()<CR>')
vim.keymap.set('n', 'gi', '<cmd>lua vim.lsp.buf.implementation()<CR>') -- 実装元へのジャンプ　具体的には、interfaceをimplementsしている実装先のファイル一覧を表示 
